...
public class DetailsFragment extends Fragment {
    ...
    private GetContactsResponse.Contact mContact;
    ...
    public static DetailsFragment newInstance(GetContactsResponse.Contact contact) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            mContact = (GetContactsResponse.Contact) getArguments().getSerializable(ARG_PARAM_CONTACT);
        }
    }
