...
public class ContactsFragment extends Fragment {
    ...
    ArrayList<GetContactsResponse.Contact> contacts = new ArrayList<>();
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
                if(response.isSuccessful()){
                    ...
                    Gson gson = new Gson();
                    GetContactsResponse getContactsResponse = gson.fromJson(body, GetContactsResponse.class);

                    contacts.clear();
                    contacts.addAll(getContactsResponse.contacts);
    ...
    class ContactsAdapter extends RecyclerView.Adapter<ContactsAdapter.ContactViewHolder>{
        ...
        public void onBindViewHolder(@NonNull ContactViewHolder holder, int position) {
            GetContactsResponse.Contact contact = contacts.get(position);
        ...
        class ContactViewHolder extends RecyclerView.ViewHolder{
            ...
            GetContactsResponse.Contact mContact;
            ...
            public void setupUI(GetContactsResponse.Contact contact){
    ...
    interface ContactsListener{
        void gotoAddContact();
        void gotoContactDetails(GetContactsResponse.Contact contact);
    }
